...
import { TeamRecords } from "@/lib/team-records";

export default function PicksGameGrid({ games, leagueGameByGame, leagueTeam, picks, sport, weekRecord, teamRecords, disabled }: { games: gameTypeExpanded[]; leagueGameByGame: Record<string, string>; leagueTeam: string; picks: pickType[]; sport: "NFL" | "NCAA"; weekRecord: string; teamRecords: TeamRecords; disabled: boolean }) {
